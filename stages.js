...
const SHIFTS = [
  {
    ...
    skyTop: [255, 200, 120],
    skyBot: [255, 235, 180],
    ambientDesc: "Take your time — you have 60 seconds per guest.",
    icon: "sunrise",
  },
  {
    id: "afternoon",
    ...
    skyTop: [100, 170, 230],
    skyBot: [180, 215, 245],
    ambientDesc: "Lunch rush. 40 seconds per guest — stay sharp.",
    icon: "sun",
  },
  {
    id: "night",
    ...
    skyTop: [18, 22, 48],
    skyBot: [35, 42, 78],
    ambientDesc: "Graveyard shift. 30 seconds per guest. Don't blink.",
    icon: "moon",
  },
];
